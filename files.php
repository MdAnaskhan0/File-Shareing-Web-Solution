...
<head>
    ...
    <style>
        ...
        .scan-result.infected, .scan-summary.infected {
            background-color: #f8d7da;
            color: #721c24;
            border: 1px solid #f5c6cb;
        }
        
        .scan-result.clean, .scan-summary.clean {
...
<body class="bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item me-2 mt-2">
                        <p><i class="fas fa-user-circle me-1"></i><?php echo htmlspecialchars($user['username']); ?></p>
                    </li>
                    ...
                    <?php } ?>
                    <li class="nav-item">
                        <a class="nav-link fw-bold" style="color: #CD2128;" href="auth.php?logout=1"><i class="fas fa-sign-out-alt me-1"></i>Logout</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="container my-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div>
                <button class="btn btn-outline-secondary me-2" data-bs-toggle="modal" data-bs-target="#passwordModal">
            ...
            <div class="card-header">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                    ...
                    <div class="d-flex flex-column flex-sm-row gap-2 w-100 w-md-auto">
                        ...
                        <span class="badge bg-secondary align-self-center align-self-sm-end"><?php echo $number_of_results; ?> files total</span>
                    </div>
                </div>
            </div>
                                    ...
                                    <tr>
                                                ...
                                                <div class="file-info">
                                                    <?php if (!empty($row['share_token'])) { ?>
                                                        <a href="share.php?token=<?php echo $row['share_token']; ?>"
                                                            title="<?php echo htmlspecialchars($fullName); ?>" class="text-decoration-none">
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <?php if ($user['role'] === 'admin') { ?>
                                                    <a href="files.php?delete=<?php echo $row['id']; ?>" class="btn btn-sm btn-danger"
                                                        onclick="return confirm('Delete this file?');" title="Delete">
                                                        <i class="fas fa-trash"></i>
                                                    </a>
                                                <?php } ?>

                                                <a href="files.php?share=<?php echo $row['id']; ?>" class="btn btn-sm btn-outline-secondary"
                                                    title="Share">
                                                    <i class="fas fa-share-alt"></i>
                                                </a>

                                                <a href="<?php echo $row['filepath']; ?>" class="btn btn-sm btn-outline-primary" title="Download"
                                                    download>
                                                ...
                                                <?php if (!empty($row['share_token'])) { ?>
                                                    <div class="share-link-container mt-1">
                                                        <input type="text"
                                                            ...
                                                            readonly class="form-control form-control-sm" id="share-link-<?php echo $row['id']; ?>">
                                                        <button class="btn btn-sm btn-outline-secondary copy-btn ms-1" onclick="copyLink(<?php echo $row['id']; ?>)"
